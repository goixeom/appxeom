...
/**
 * Created by DuongKK on 8/31/2017.
 */
// ref https://github.com/kanytu/custom-rating-bar/blob/master/src/main/java/com/poliveira/apps/CustomRatingBar.java
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.layer_star_rate;
    private int mStarOffResource = R.drawable.layer_star__nonrate;
    private int mStarHalfResource = R.drawable.layer_star_rate;
